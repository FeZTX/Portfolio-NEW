(() => {
    ...
    class MouseClass {
        ...
        init(container) {
            ...
            const defaultView =
                (this.docTarget && this.docTarget.defaultView) || window;
    ...
    const bg = new THREE.Color(CONFIG.backgroundColor);
    const bgVec4 = CONFIG.lightMode
